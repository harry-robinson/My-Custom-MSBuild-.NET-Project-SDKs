...
|---|---|---|---|
| `Meziantou.Analyzer` | `3.0.71` | `MyCustom.NET.Sdk` | A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance and style. |
