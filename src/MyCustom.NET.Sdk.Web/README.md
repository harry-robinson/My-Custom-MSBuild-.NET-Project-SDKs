...
```xml
<Project Sdk="MyCustom.NET.Sdk.Web/1.0.4">
```
...
|---|---|---|---|
| `Meziantou.Analyzer` | `3.0.49` | `MyCustom.NET.Sdk` | A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance and style. |
