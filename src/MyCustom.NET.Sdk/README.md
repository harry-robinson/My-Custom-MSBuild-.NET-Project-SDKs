...
```xml
<Project Sdk="MyCustom.NET.Sdk/1.0.5">
```
...
|---|---|---|
| `Meziantou.Analyzer` | `3.0.71` | A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance and style. |
