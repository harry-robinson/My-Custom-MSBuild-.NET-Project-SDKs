...
```xml
<Project Sdk="MyCustom.NET.Sdk/1.0.6">
```
...
| `Meziantou.Analyzer` | `3.0.114` | A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance and style. |
...
| `Microsoft.VisualStudio.Threading.Analyzers` | `18.7.23` | Static code analyzers to detect common mistakes or potential issues regarding threading and async coding. |
| `Roslynator.Analyzers` | `4.15.0` | A collection of 200+ analyzers for C#, powered by Roslyn. |
